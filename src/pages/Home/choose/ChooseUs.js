...
const ChooseUs = () => {
    return (
        <div className="text-center space-y-4 bg-yellow-50 p-8">
            <h1 className="text-gray-500 text-3xl ">Why Choose us</h1>
            <h2>The reason you should choose us</h2>
            <div>
            ...
            <div>
                <h1>We are improving everyday.</h1>
                <p>Nunc fringilla eros vitae nisl posuere, ut consectetur nulla feugiat. Nullam ut mauris vitae tortor sodales efficitur.</p>
            </div>
        </div>
    )

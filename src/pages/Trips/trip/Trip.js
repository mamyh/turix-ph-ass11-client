    ...
    return (
        <div className="bg-white hover:shadow-lg rounded-md">
            ...
            <div className="text-center mb-8">
                <Link className="text-xl text-white bg-yellow-600 inline-block w-1/3 p-2 rounded-bl-full rounded-tl-full rounded-br-full rounded-tr-full" to={`/trips/${_id}`}>Book Now</Link>
            </div>
        </div>
    )
}
